  ...
  $(function() {
    ...
    $('#daterange').daterangepicker({
      ...
      $('#daterange').on('apply.daterangepicker', function(ev, picker) {
        window.location.href = window.location.origin+"/dashboard?start_date=" + picker.startDate.format('YYYY-MM-DD') + "&end_date=" + picker.endDate.format('YYYY-MM-DD');   
      });
      
    var areaChartData = {
      labels  : @json($productCategory) ,
      datasets: [
        {
          label               : 'Purchased',
          backgroundColor     : 'rgba(15, 3, 9, 1)',
